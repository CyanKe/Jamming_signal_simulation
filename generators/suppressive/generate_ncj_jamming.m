function [pure_jam] = generate_ncj_jamming(tx, params, data_num)
    % generate_ncj_jamming - 生成噪声卷积干扰(Noise Convolution Jamming, NCJ) 
    % tx: 包含 LFM 信号的发射数据
